...
Además, en el caso de que el tipo del escenario elegido sea para vehículos y para turnos, se podrá ver la solución generada de turnos desde la vista de personal.
...
2. La solución del escenario cambió a estado **Validada**.
...
1. La solución del escenario ya está en estado **Validada**.
...
1. Revisa la tabla de escenarios y confirma el estado **Validada**.
...
3. La solución del escenario está **Validada**.
