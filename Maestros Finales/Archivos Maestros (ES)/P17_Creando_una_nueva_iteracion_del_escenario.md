...
Usa esta quick start cuando ya tengas un escenario con una solución en estado **Publicada** y necesites generar una nueva variante sin perder la referencia histórica de la solución implantada.

Antes de empezar, asegúrate de que:
1. Ya publicaste el escenario anterior en P16.
2. La solución del escenario que tomarás como base está en estado **Publicada**.
...
2. Localiza el escenario cuya solución esté en estado **Publicada**.
...
2. Selecciona la opción para **crear una nueva iteración** clicando en **duplicar** el escenario como base de trabajo.
...
- **Cálculo Clásico - L1 laborable - Iteración 2**
