...
2. Selecciona la **solución de Scheduling** que actuará como entrada, esto es, qué solución está publicada para un rango de fechas.
...
1. Inicia la configuración del cálculo de asignación mediante la creación de un nuevo escenario de rostering.
2. Selecciona los siguientes datos de entrada:
   1. Los **Depósitos** que participarán.
   2. Selecciona las **fechas** del nuevo escenario de rostering.
...
5. Comprueba que el cálculo ya tiene:
