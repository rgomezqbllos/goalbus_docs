...
1. En GoalBus ve a **Configuración** > **Vehículos** > **Reglas de tipos de vehículos**.
...
1. Dentro del modelo de reglas, revisa el catálogo de reglas disponibles pulsando en **Agregar Nueva Regla**.
ref: P12_Imagen3.png
2. Identifica cuáles responden a las necesidades reales de tu servicio seleccionando la **plantilla** que corresponda.
3. Define un **Nombre** y escribe una **Descripción** para cada nueva regla.
4. Activa solo las reglas que realmente necesites para el caso.
5. Configura los parámetros específicos de cada regla cuando aplique.
6. Repite el proceso hasta cubrir las restricciones mínimas necesarias.
7. Guarda los cambios.
8. Revisa el modelo completo y confirma que no es muy restrictivo ni demasiado abierto.
