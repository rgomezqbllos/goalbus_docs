...
Usa esta quick start cuando ya tengas un escenario con una solución en estado **Validada** y necesites llevarlo a operación para un período específico.

Antes de empezar, asegúrate de que:
1. Ya ejecutaste y validaste el escenario en P15.
2. La solución del escenario que quieres publicar está en estado **Validada**.
...
3. Comprueba que el estado actual de la solución es **Validada**.
...
7. Confirma la publicación para el/los rango/s de fecha elegido/s.
...
6. Revisa que el estado final de la solución cambia a **Publicada**.
...
1. La solución del escenario de L1 ya salió de **Validada**.
2. La plataforma procesó la publicación.
3. La solución del estado final del escenario es **Publicada**.
...
Antes de empezar esta sección, asegúrate de que:
1. La solución del escenario ya llegó a estado **Publicada**.
...
3. Confirma que la solución publicada del escenario aparece como **Publicada**.
...
2. Usa el estado **Publicada** como referencia para distinguirlo de escenarios en borrador, cálculo o validación.
