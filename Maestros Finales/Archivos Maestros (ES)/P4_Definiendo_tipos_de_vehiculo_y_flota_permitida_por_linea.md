...
7. Si el tipo **no existe**, sal de la configuración de la línea y ve a la configuración general de **vehículos** para crear o completar primero el catálogo de tipos disponible desde el panel de **Tipos de Vehículos**.
