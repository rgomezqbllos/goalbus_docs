...
3. Revisa el catálogo de reglas básicas disponibles.
...
5. **Día libres por semana**
6. **Primera Solución Publicada**
7. **Grupo de trabajo**
8. **Emparejamiento**
9. **Compatibilidad de asignación**
10. **Habilitación de Línea**
11. **Turno de Primera Solución Publicada**
12. **Días de trabajo consecutivos**, cuando aplique
...
1. En **Configuración** > **Reglas de asignación**, abre la sección **Modelos de Reglas**.
...
9. Activa el modelo de reglas creado.
10. Revisa que el modelo ya pueda asignarse al cálculo de Rostering adecuado.
