...
2. Abre la sección **Gestión de Tiempo** > **Años operacionales**.
...
4. Si no existe un año operativo adecuado, haz clic en la opción para crear uno nuevo pulsando en **Crear Año Operacional**.
...
2. Revisa la **Fecha de inicio** y la **Fecha de Fin**.
