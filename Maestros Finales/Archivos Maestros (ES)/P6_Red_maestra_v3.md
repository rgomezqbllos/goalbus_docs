...
1. En GoalBus, ve al módulo de **Configuración de Paradas** dentro de la configuración de servicios.
ref: P6_Imagen1.png
...
4. Si una parada no existe, haz clic en **Nueva Parada**.
...
1. En GoalBus, ve al módulo de **Configuración de la Red**.
ref: P6_Imagen3.png
2. Busca si la línea que necesitas ya existe.
3. Si la línea ya existe, ábrela y revisa su configuración.
4. Si no existe, crea una nueva línea pulsando en **Crear línea**.
5. Define o valida:
   1. **Nombre de la Línea** para nombre interno.
   2. **Nombre corto** para vistas compactas.
   3. **Nombre comercial**, si aplica.
   4. **Parkings** asociados a la línea. **OJO: es necesaria la creación previa de Párkings.**
   5. **Tipos de vehículos** para asociar los tipos de vehículos disponibles para la línea. **OJO: es necesaria la creación previa de los tipos de vehículo.**
   6. **ID Externo** para añadir un identificador extra.
