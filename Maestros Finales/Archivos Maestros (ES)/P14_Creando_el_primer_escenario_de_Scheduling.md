...
Cuando termines esta sección, deberías tener un escenario creado con sus entradas logísticas y comerciales correctas creado como en la siguiente imagen:
...
1. Abre el escenario que acabas de crear presionando sobre el mismo.
...
2. Reserva el motor de aprendizaje automático solo para validaciones rápidas previas, no como motor del cálculo final. 
3. Usa una flexibilidad inicial moderada si sospechas que las restricciones podrían bloquear la primera solución.
4. Define un tiempo máximo realista para que el equipo reciba una solución viable dentro del plazo esperado. fileciteturn34file0L1-L20fileciteturn34file0L1-L20 fileciteturn34file2L1-L20
