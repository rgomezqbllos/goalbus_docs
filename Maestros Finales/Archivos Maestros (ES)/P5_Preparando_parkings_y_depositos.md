...
5. Define o valida estos campos:
   ...
   3. **Porcentaje de participación %** como participación del depósito en el total de operaciones. Entre todos los depósitos deben sumar 100%.
   4. **Nombre largo** como nombre principal del depósito.
...
5. Define o valida estos campos:
   ...
   2. **Nombre corto** para vistas compactas.
   3. **Nombre largo** como nombre descriptivo del garaje o patio.
...
Cuando termines esta sección, deberías tener un parking correctamente geolocalizado y correctamente subordinado al depósito adecuado.

## Validando la coherencia entre parking, depósito y línea

Ahora que ya tienes configurados parking y depósito, necesitas comprobar que esa infraestructura encaja con la lógica de línea y con la eficiencia logística que GoalBus espera. El propio modelo de línea permite definir **aparcamientos o depósitos permitidos** para obligar al sistema a iniciar servicio desde las bases geográficamente correctas y minimizar kilometraje en vacío. Esto no es una preferencia cosmética: guía directamente al programador cuando construye soluciones.
...
Cuando termines esta sección, deberías poder afirmar que la línea, el depósito y el parking forman una misma lógica operativa y logística.
