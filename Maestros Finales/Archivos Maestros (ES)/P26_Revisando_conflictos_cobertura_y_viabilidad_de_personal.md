...
4. Para ello, ayúdate de los KPIs visibles en la solución.
ref: P26_Imagen1.png | compact
4. Comprueba si la cobertura es completa o si hay huecos gracias a los KPIs diarios visibles.
ref: P26_Imagen2.png | full
5. Si el sistema muestra contadores o resúmenes de cobertura (KPIs de conductores), revísalos.
